...
import { LayoutDashboard, Users, Receipt, MessageCircle, BarChart3, Settings, Zap, Wallet, FileMinus, LogOut, ShieldCheck, Lock, Menu, UserCheck, Calculator, TrendingUp } from "lucide-react";
...
const nav = [
  ...
  { to: "/faturamento-geral", label: "Faturamento Geral", icon: TrendingUp },
