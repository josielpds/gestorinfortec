...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestão financeira, cobranças, fluxo de caixa, controle fiscal e relatórios com envio via WhatsApp." },
      { property: "og:title", content: "Gestor Financeiro Infortec — Gestão e Cobranças via WhatsApp" },
      { property: "og:description", content: "Gestão financeira, cobranças, fluxo de caixa, controle fiscal e relatórios com envio via WhatsApp." },
